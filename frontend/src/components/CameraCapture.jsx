  ...
  export default function CameraCapture({ sessionId, onSuccess, onFaceMismatch }) {
    ...
    function detectBlink(landmarks) {
      ...
      if (blinkCounterRef.current >= 2) setBlinkOk(true);
    }
    ...
    function detectHeadMovement(landmarks) {
      ...
      if (Math.abs(nose.x - noseXRef.current) > 0.03) {
        setHeadOk(true);
      }
    }
      ...
      <div className="camera-container">
        <div className="camera-card">
          ...
          <div style={{ marginBottom: "10px" }}>
            <p style={{ color: blinkOk ? "#10b981" : "#f59e0b", fontWeight: "bold" }}>
              👁 Blink: {blinkOk ? "Detected ✅" : "Waiting..."}
            </p>

            <p style={{ color: headOk ? "#10b981" : "#f59e0b", fontWeight: "bold" }}>
              ↔️ Head Movement: {headOk ? "Detected ✅" : "Waiting..."}
            </p>
          </div>
          {/* 🔴 END STATUS BLOCK */}
